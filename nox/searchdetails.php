...
$pid=$_GET['pid'];
					...
					$sql = mysql_query("SELECT * FROM products where name='".$sellerid."' and id='".$pid."'")
					or die(mysql_error());  
...
<a href="about1.php?sellerid=<?php echo $uname;?>" class="buttonWrap button button-red contactSubmitButton" >Seller Details</a>
