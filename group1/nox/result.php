...
$sellerid=$_GET['sellerid'];
					...
					$sql = mysql_query("SELECT * FROM products  where name='".$sellerid."' ORDER BY price DESC")
					or die(mysql_error());  
                    ...
                    <article>
                        ...
                        <div class="text">
                            <h2>
                                ...
                                <b><a onclick="javascript:location.href='http://localhost:8080/group1/nox/#!/searchdetails.php?sellerid=<?php echo $sellerid; ?>&pid=<?php echo $pid; ?>'"><?php echo @$name;?></a></b>
